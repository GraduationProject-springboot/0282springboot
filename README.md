...
# 0282springboot图书商城管理系统

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1jqaLe1EbH?p=48)


# 绪论
## 1.1 研究背景
当前社会各行业领域竞争压力非常大，随着当前时代的信息化，科学化发展，让社会各行业领域都争相使用新的信息技术，对行业内的各种相关数据进行科学化，规范化管理。这样的大环境让那些止步不前，不接受信息改革带来的信息技术的企业随时面临被淘汰，被取代的风险。所以当今，各个行业领域，不管是传统的教育行业，餐饮行业，还是旅游行业，医疗行业等领域都将使用新的信息技术进行信息革命，改变传统的纸质化，需要人手工处理工作事务的办公环境。软件信息技术能够覆盖社会各行业领域是时代的发展要求，各种数据以及文件真正实现电子化是信息社会发展的不可逆转的必然趋势。本图书商城管理系统也是紧跟科学技术的发展，运用当今一流的软件技术实现软件系统的开发，让考试信息完全通过管理系统实现科学化，规范化，程序化管理。从而帮助信息管理者节省事务处理的时间，降低数据处理的错误率，对于基础数据的管理水平可以起到促进作用，也从一定程度上对随意的业务管理工作进行了避免，同时，图书商城管理系统的数据库里面存储的各种动态信息，也为上层管理人员作出重大决策提供了大量的事实依据。总之，图书商城管理系统是一款可以真正提升管理者的办公效率的软件系统。
## 1.2 目的和意义
信息数据的处理完全依赖人工进行操作，会耗费大量的人工成本，特别是面对大量的数据信息时，传统人工操作不仅不能对数据的出错率进行保证，还容易出现各种信息资源的低利用率与低安全性问题。更有甚者，耽误大量的宝贵时间，尤其是对信息的更新，归纳与统计更是耗财耗力的过程。所以电子化信息管理的出现就能缓解以及改变传统人工方式面临的处境，一方面可以确保信息数据在短时间被高效处理，还能节省人力成本，另一方面可以确保信息数据的安全性，可靠性，并可以实现信息数据的快速检索与修改操作，这些优点是之前的旧操作模式无法比拟的。因此图书商城管理系统为数据信息的管理模式的升级与改革提供了重要的窗口。
## 1.3 论文结构安排
...
![C:\Users\Administrator\Desktop\img\tushushangcheng\用户.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\tushushangcheng\用户.jpg")
图4.1 用户实体属性图

（2）下图是图书实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\tushushangcheng\图书.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\tushushangcheng\图书.jpg")
图4.2 图书实体属性图

（3）下图是图书评价实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\tushushangcheng\图书评价.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\tushushangcheng\图书评价.jpg")
图4.3 图书评价实体属性图

（4）下图是图书订单实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\tushushangcheng\图书订单.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\tushushangcheng\图书订单.jpg")
图4.4 图书订单实体属性图

（5）下图是购物车实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\tushushangcheng\购物车.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\tushushangcheng\购物车.jpg")
图4.5 购物车实体属性图

（6）下图是收货地址实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\tushushangcheng\收货地址.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\tushushangcheng\收货地址.jpg")
图4.6 收货地址实体属性图

（7）下图是图书收藏实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\tushushangcheng\图书收藏.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\tushushangcheng\图书收藏.jpg")
图4.7 图书收藏实体属性图
### 4.3.2 数据库表结构设计
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|tushu\_name|String|图书名称|是|
|3|tushu\_photo|String|图书照片|是|
|4|tushu\_types|Integer|图书类型|是|
|5|tushu\_kucun\_number|Integer|图书库存|是|
|6|tushu\_price|Integer|购买获得积分|是|
|7|tushu\_old\_money|BigDecimal|图书原价|是|
|8|tushu\_new\_money|BigDecimal|现价|是|
|9|tushu\_clicknum|Integer|点击次数|是|
|10|tushu\_content|String|图书简介|是|
|11|shangxia\_types|Integer|是否上架|是|
|12|tushu\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|tushu\_order\_uuid\_number|String|订单号|是|
|3|address\_id|Integer|收获地址|是|
|4|tushu\_id|Integer|图书|是|
|5|yonghu\_id|Integer|用户|是|
|6|buy\_number|Integer|购买数量|是|
|7|tushu\_order\_true\_price|BigDecimal|实付价格|是|
|8|tushu\_order\_courier\_name|String|快递公司|是|
|9|tushu\_order\_courier\_number|String|订单快递单号|是|
|10|tushu\_order\_types|Integer|订单类型|是|
|11|tushu\_order\_payment\_types|Integer|支付类型|是|
